    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <div style={styles.titleSection}>
          <h2 style={styles.documentTitle}>CREDIT NOTE</h2>
          <span style={styles.statusPill}>REFUNDED</span>
        </div>
      </div>
      ...
      {data.refundDetails && (
        <div style={styles.refundBox}>
          <h3 style={styles.sectionTitle}>REFUNDED TO:</h3>
          <p style={styles.refundDetails}>{data.refundDetails}</p>
        </div>
      )}
